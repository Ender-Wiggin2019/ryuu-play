...
const defaultSeed: VariantTrainerSeed = {
  set: 'set_h',
  name: '巧可果',
  fullName: '巧可果 185/207#17975',
  text: '身上放有这张卡牌的宝可梦，受到对手【火】宝可梦的招式的伤害时，那个伤害「-60」，将这张卡牌放于弃牌区。\n在自己的回合可以将任意张宝可梦道具卡，放于自己的宝可梦身上。每只宝可梦身上只可以放1张宝可梦道具卡，并保持附加状态。',
  ...
  rawData: {
    raw_card: {
      ...
      image: 'https://pub-a275b3fdda064fe5a8c45a3a5afb1266.r2.dev/458/500.png',
      ruleLines: [
        '身上放有这张卡牌的宝可梦，受到对手【火】宝可梦的招式的伤害时，那个伤害「-60」，将这张卡牌放于弃牌区。',
        '在自己的回合可以将任意张宝可梦道具卡，放于自己的宝可梦身上。每只宝可梦身上只可以放1张宝可梦道具卡，并保持附加状态。',
      ],
      attacks: [],
      features: [],
    ...
    image_url: 'https://pub-a275b3fdda064fe5a8c45a3a5afb1266.r2.dev/458/500.png',
  },
};

export class QiaoKeGuo extends VariantTrainerCard {
  ...
  public reduceEffect(store: StoreLike, state: State, effect: Effect): State {
    if (effect instanceof DealDamageEffect && effect.target.trainers.cards.includes(this)) {
      ...
      if (effect.player !== owner && effect.damage > 0 && sourcePokemon?.cardTypes.includes(CardType.FIRE)) {
