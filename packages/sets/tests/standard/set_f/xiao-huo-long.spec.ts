...
import { XiaoHuoLong, XiaoHuoLongCs5aC, XiaoHuoLongCsv5C } from '../../../src/standard/set_f/xiao-huo-long';
...
describe('xiao-huo-long set_f', () => {
  it('registers all F/G same-name variants with separate logic groups', () => {
    const cards = setF.filter(card => card.name === '小火龙');
