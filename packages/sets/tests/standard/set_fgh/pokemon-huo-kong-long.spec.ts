...
import { HuoKongLong151C } from '../../../src/standard/set_fgh/huo-kong-long-151c';
import { HuoKongLongCsv5c } from '../../../src/standard/set_fgh/huo-kong-long-csv5c';
import { HuoKongLongCs5aC } from '../../../src/standard/set_fgh/huo-kong-long-cs5ac';
import { TestPokemon } from '../../test-cards/test-pokemon';
import { TestUtils } from '../../test-utils';

function groupByLogicKey() {
  const cards = setFgh.filter(card => card.name === '火恐龙') as any[];
