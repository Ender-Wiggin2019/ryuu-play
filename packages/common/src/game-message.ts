...
export enum GameStoreMessage {
  ...
  SETUP_CHOOSE_COIN_SIDE = 'SETUP_CHOOSE_COIN_SIDE',
  SETUP_COIN_SIDE_HEADS = 'SETUP_COIN_SIDE_HEADS',
  SETUP_COIN_SIDE_TAILS = 'SETUP_COIN_SIDE_TAILS',
  SETUP_CHOOSE_TURN_ORDER = 'SETUP_CHOOSE_TURN_ORDER',
  SETUP_TURN_ORDER_FIRST = 'SETUP_TURN_ORDER_FIRST',
  SETUP_TURN_ORDER_SECOND = 'SETUP_TURN_ORDER_SECOND',
...
export enum GameLog {
  ...
  LOG_SETUP_COIN_TOSS_CALL = 'LOG_SETUP_COIN_TOSS_CALL', // { name }
  LOG_SETUP_COIN_TOSS_CHOICE = 'LOG_SETUP_COIN_TOSS_CHOICE', // { name, choice }
  LOG_SETUP_COIN_TOSS_WON = 'LOG_SETUP_COIN_TOSS_WON', // { name }
  LOG_SETUP_COIN_TOSS_LOST = 'LOG_SETUP_COIN_TOSS_LOST', // { name, opponent }
  LOG_SETUP_TURN_ORDER_CHOICE = 'LOG_SETUP_TURN_ORDER_CHOICE', // { name, choice }
